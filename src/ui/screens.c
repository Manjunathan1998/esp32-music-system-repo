...
void create_screen_equalizer() {
    ...
    lv_obj_set_size(obj, 160, 128);
    {
        ...
        // {
        //     // scan
        //     lv_obj_t *obj = lv_qrcode_create(parent_obj, 56, lv_color_hex(0xff20429f), lv_color_hex(0xffe2f5fe));
        //     objects.scan = obj;
        //     lv_obj_set_pos(obj, 52, 36);
        //     lv_obj_set_size(obj, 56, 57);
        //     //lv_qrcode_update(obj, "https://envox.eu/", 17);
        //     lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
        // }
    }
    
    tick_screen_equalizer();
}
