...
void create_screen_bt_screen()
{
    ...
    lv_obj_set_style_bg_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.artist_name_placeholder = obj;
            lv_obj_set_pos(obj, 46, 60);
            lv_obj_set_size(obj, 106, 11);
        ...
        {
            // trackNamePlaceholder
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.track_name_placeholder = obj;
        ...
        {
            // playStatusPlaceholder
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.play_status_placeholder = obj;
            lv_obj_set_pos(obj, 54, 92);
            lv_obj_set_size(obj, 89, 11);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xfff0f0f0), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffd6810f), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_letter_space(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text(obj, "BT Devices");
                        }
                    }
                }
            }
...
void create_screen_bt_devices_page()
{
    ...
    lv_obj_set_style_text_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            // battery_skeleton_5
            lv_obj_t *obj = lv_bar_create(parent_obj);
            objects.battery_skeleton_5 = obj;
            lv_obj_set_pos(obj, 132, 5);
            lv_obj_set_size(obj, 22, 11);
            lv_obj_set_style_border_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            // bt_list_container
            lv_obj_t *obj = lv_obj_create(parent_obj);
            objects.bt_list_container = obj;
            lv_obj_set_pos(obj, 8, 16);
            ...
            lv_obj_set_style_pad_left(obj, 4, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    // lbl_mac_placeholder
                    lv_obj_t *obj = lv_label_create(parent_obj);
                    objects.lbl_mac_placeholder = obj;
                    lv_obj_set_pos(obj, 33, 38);
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_font(obj, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            // btn_clear_bt
            lv_obj_t *obj = lv_btn_create(parent_obj);
            objects.btn_clear_bt = obj;
            lv_obj_set_pos(obj, 2, 105);
            lv_obj_set_size(obj, 100, 16);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0292a0), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffd6810f), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_letter_space(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text(obj, "Clear MACs");
                }
            }
        }
        {
            // total_dev_label
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.total_dev_label = obj;
            lv_obj_set_pos(obj, 2, 92);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_color(obj, lv_color_hex(0xffffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_opa(obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "Total devices: ");
        }
    }

    tick_screen_bt_devices_page();
}
